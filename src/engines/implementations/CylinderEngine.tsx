...
export const CylinderEngine = forwardRef<EngineImperativeAPI, EngineProps>((props, ref) => {
...
CylinderEngine.displayName = 'CylinderEngine';
export default CylinderEngine;
